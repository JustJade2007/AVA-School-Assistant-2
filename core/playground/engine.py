...
class PlaygroundEngine:
    ...
    def generate_outline(self, project: PlaygroundProject) -> List[SectionDraft]:
        ...
        system_prompt = (
            ...
            "- 'title': Section heading (e.g. 'Introduction & Thesis', 'Historical Context', 'Counterarguments', 'Conclusion')\n"
        ...
        total = project.target_total_words or 1000
    ...
    def draft_section(
        ...
        Automatically passes through Jade's AI Humanizer if enabled.
        """
        ...
        system_prompt = (
            "You are an expert scholarly author writing a section of a high-quality paper.\n"
            "RULES:\n"
            f"1. Target Length: Approximately {section.target_word_count} words.\n"
            "2. Tone: Academic, rigorous, insightful, and natural. Avoid formulaic AI clichés.\n"
            "3. Ground your analysis thoroughly in the provided sources and address the specified rubric criteria.\n"
            "4. Return ONLY the drafted paragraphs. Do NOT include section title headers, meta-commentary, or notes."
        )
        ...
        if auto_humanize and humanizer_bridge:
            ...
            section.humanized_text = h_res.get("humanized_text", section.raw_ai_text).strip()
    ...
    def refine_section(
        ...
        system_prompt = (
            ...
            "2. Preserve the factual accuracy and academic substance while enhancing style and structure.\n"
            "3. Return ONLY the revised draft text without conversational intros or quotes."
        )
